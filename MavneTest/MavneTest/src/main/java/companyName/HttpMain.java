...
public class HttpMain {
    ...
    public static void main(String[] args) throws InterruptedException, IOException {
        FileInputStream fileInputStream = new FileInputStream(new File("text1.txt"));
        final String keji = "鲸科技";
        ExecutorService service = Executors.newFixedThreadPool(20);

        BufferedReader br = new BufferedReader(new FileReader(new File("text1.txt")));
        String line = "";
        ...
        for (int i = 0; i < str.length(); i++) {
            String finalString = str.charAt(i) + keji;
//            service.submit(() -> {
//                try {
